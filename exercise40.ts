...
console.log(make_album('artist 1', 'Title 1' , 12))
console.log(make_album('artist 2', 'Title 2'));
console.log(make_album('artist 3', 'Title 3', 10))
...
let album1=make_album('artist 1', 'Title 1' , 12)
let album2=make_album('artist 2', 'Title 2')
let album3=make_album('artist 3', 'Title 3', 10)
